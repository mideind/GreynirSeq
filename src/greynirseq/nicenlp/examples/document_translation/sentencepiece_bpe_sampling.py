# this is a slight modification of a the file from fairseq (fairseq/data/encoders/sentencepiece_bpe.py)
...
@register_bpe('sentencepiece_sampled')
class SentencepieceBPESampled(object):
    ...
    def __init__(self, args):
        ...
        self.alpha = args.sentencepiece_alpha
        try:
