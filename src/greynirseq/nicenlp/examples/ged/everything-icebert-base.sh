...
#   train.input0
#   train.label
SOURCE_DATA_DIR="/data/scratch/petur/grammatical-error-detection-2/data/simcategories/"
# PROCESSED_DATA_DIR is where processed data files get written
PROCESSED_DATA_DIR="/data/scratch/petur/grammatical-error-detection-2/data-prepared/simcategories/"
# ENCODER_JSON is often something like *vocab.json
ENCODER_JSON="/data/models/icebert/bpe_vocab/vocab.json"
# VOCAB_BPE is often something like *merges.txt
VOCAB_BPE="/data/models/icebert/bpe_vocab/merges.txt"
# DICT is the dictionary file for the pretrained models.
DICT="/data/models/icebert/bpe_vocab/tokenized_dict.txt"
# MODELS_DIR is a directory containing model files.
# Their names should end in .pt
MODELS_DIR="/data/scratch/petur/grammatical-error-detection-2/models/"
...
GREYNIRSEQ_GIT="/home/petur/code/GreynirSeq/"
GREYNIRSEQ_PATH="$GREYNIRSEQ_GIT/src/greynirseq"
# TERM_SCHEMA is the label schema for the multilabel task
TERM_SCHEMA="/data/scratch/petur/grammatical-error-detection-2/ged-simcategories-schema.json"
